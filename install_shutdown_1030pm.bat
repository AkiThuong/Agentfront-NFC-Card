...
schtasks /delete /tn "AgentFront_ShutdownPC_815PM" /f >nul 2>&1

:: Create shutdown script
set "SHUTDOWN_SCRIPT=%SCRIPT_DIR%_shutdown_pc_815pm.bat"
...
set "SHUTDOWN_TASK_XML=%SCRIPT_DIR%_shutdown_task_815pm.xml"
...
schtasks /create /tn "AgentFront_ShutdownPC_815PM" /xml "%SHUTDOWN_TASK_XML%" /f
if %errorLevel% equ 0 (
...
echo   schtasks /delete /tn "AgentFront_ShutdownPC_815PM" /f
echo.
echo ========================================
echo Press any key to exit...
pause >nul
