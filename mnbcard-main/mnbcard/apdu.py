...
# The header at bytes 3-13 contains pointers to each data segment:
# data[7] -> NAME position, data[9] -> ADDRESS position, etc.
class BASE_FOUR_MANIFEST:
    NAME_SEGMENT_START          = 7
    ADDRESS_SEGMENT_START       = 9
    BIRTHDATE_SEGMENT_START     = 11
    GENDER_SEGMENT_START        = 13
