...
title PC Shutdown Schedule Installer (4:40 PM Only)
...
echo   - Shutdown at 4:40 PM (Every day)
echo.
...
:: ========================================
:: Create Shutdown PC Task (4:40 PM)
:: ========================================
echo Creating Shutdown PC task for 4:40 PM...
echo.
...
echo shutdown /s /f /t 60 /c "Scheduled shutdown at 4:40 PM"
) > "%SHUTDOWN_SCRIPT%"
...
echo     ^<Description^>Shutdown PC for AgentFront at 4:40 PM^</Description^>
echo   ^</RegistrationInfo^>
echo   ^<Triggers^>
echo     ^<CalendarTrigger^>
echo       ^<StartBoundary^>2024-01-01T16:40:00^</StartBoundary^>
...
echo.
echo Schedule:
echo   - PC shuts down at 4:40 PM (Every day)
echo.
